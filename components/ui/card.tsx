...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-4xl border bg-card text-card-foreground shadow-sm flex flex-col gap-4 p-6 transition-all duration-200 hover:shadow-md dark:bg-card dark:border-border dark:text-card-foreground",
      className
    )}
    {...props}
  />
