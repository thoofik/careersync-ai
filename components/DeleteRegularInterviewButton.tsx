...
interface DeleteRegularInterviewButtonProps {
  interviewId: string;
  className?: string;
}

const DeleteRegularInterviewButton = ({ interviewId, className = '' }: DeleteRegularInterviewButtonProps) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              and all associated feedback data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
export default DeleteRegularInterviewButton; 